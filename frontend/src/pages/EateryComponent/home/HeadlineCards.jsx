    ...
    <div className="max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6">
      ...
      <div className="rounded-xl relative">
        ...
        <div className="absolute w-full h-full bg-black/50 rounded-xl text-white">
          ...
          <button className="border-white bg-white border rounded-full px-2 text-black mx-2 absolute bottom-4">
            Order Now
          </button>
        </div>
        <img
      ...
      <div className="rounded-xl relative">
        ...
        <div className="absolute w-full h-full bg-black/50 rounded-xl text-white">
          ...
          <button className="border-white border rounded-full px-2 bg-white text-black mx-2 absolute bottom-4">
            Order Now
          </button>
        </div>
        <img
