...
const Food = () => {
  ...
  return (
    <div className="max-w-[1640px] m-auto px-24 py-12 w-full">
      ...
      {/* Filter Row */}
      <div className="flex flex-col mx-auto  justify-center max-w-lg">
        {/* Fliter Type */}
        <div>
          <div className="flex flex-row gap-4 overflow-y-auto p-4 font-[quicksand] font-[600] border-none">
            ...
            <button
              onClick={() => filterCategory("protein")}
              className="m-1 bg-[#ECBF76] text-black  rounded-full px-2 hover:bg-orange-600 hover:text-white"
            >
              Protein
            </button>
            <button
              onClick={() => filterCategory("soup")}
              className="m-1 bg-[#ECBF76] text-black  rounded-full px-2 hover:bg-orange-600 hover:text-white"
            >
              Soup
            </button>
      ...
      {/* Display foods */}
      <div className="flex flex-col mx-auto items-center justify-center max-w-[1240px] pt-4">
